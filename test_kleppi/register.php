...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($plain_password)) {
        ...
        try {
            // Se agrega un nuevo campo 'role' con el valor por defecto 'customer'.
            ...
            $logger->info("Nuevo usuario '{$username}' registrado con rol 'customer'.");
            ...
            $logger->error("Error al registrar el usuario '{$username}': " . $e->getMessage());
        }
    }
}
?>
...
<div class="container">
    ...
    <?php if (isset($message)): ?>
        <div class="message <?php echo strpos($message, 'exitosamente') !== false ? 'success' : 'error'; ?> show">
